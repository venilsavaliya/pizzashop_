...
$(document).on("click", "#modifierGroupSelectBoxForAddEdit", function () {
  ...
  $(document).on('submit',"#AddEditModifierItemForm",function (e) {
    ...
    var selectedModGroupId = Array.from(selectedGroupsForAddEdit).map((item) => item.id);
...
$(document).ready(function () {
  ...
  //   const selectedModifierGroups = $(
  //     "#modifierGroupDropdown input:checked"
  //   ).length;
  ...
  //   const selectedModifierGroups = $(
  //     "#modifierGroupDropdownForEdit input:checked"
  //   ).length;
